class MarketInsight {
  ...
  MarketInsight.fromJson(Map<String, dynamic> json) {
    ...
    dayBeforeYesterdayPrice =
        json['day_before_yesterday_price'] ?? 0; // Default to 0 if null
    todaysPriceChange =
        json['todays_price_change'] ?? 0; // Default to 0 if null
    yesterdaysPriceChange =
        json['yesterdays_price_change'] ?? 0; // Default to 0 if null
    date = json['date'] != null
