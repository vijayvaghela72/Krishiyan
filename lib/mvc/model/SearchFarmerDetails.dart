class SearchFarmerDetails {
  bool? success;
  String? message;
  List<SearchFarmerData>? searchFarmerData;

  SearchFarmerDetails({this.success, this.message, this.searchFarmerData});

  SearchFarmerDetails.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    if (json['data'] != null) {
      searchFarmerData = <SearchFarmerData>[];
      json['data'].forEach((v) {
        searchFarmerData!.add(SearchFarmerData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.searchFarmerData != null) {
      data['data'] = this.searchFarmerData!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class SearchFarmerData {
  String? sId;
  String? dealerNumber;
  String? name;
  ...
  SearchFarmerData.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
