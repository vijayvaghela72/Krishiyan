...
class AppColor {
  static const Color transparentColor = Colors.transparent; // Example transparent color

  static const Color backgroundColor = Color(0xFFf9f9f9); // Example background background
  static const Color iconColor = Color(0xFF666666); // Example icon background
