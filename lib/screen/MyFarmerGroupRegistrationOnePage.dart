...
class MyFarmerGroupRegistrationOnePage extends StatefulWidget {
  const MyFarmerGroupRegistrationOnePage({super.key});

  @override
  State<MyFarmerGroupRegistrationOnePage> createState() => _MyFarmerGroupRegistrationOnePageState();
}

class _MyFarmerGroupRegistrationOnePageState extends State<MyFarmerGroupRegistrationOnePage> {
