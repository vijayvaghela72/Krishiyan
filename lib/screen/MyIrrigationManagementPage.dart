...
class MyIrrigationManagementPage extends StatefulWidget {
  bool aapbarVisibility;

  MyIrrigationManagementPage({super.key, required this.aapbarVisibility});

  @override
  State<MyIrrigationManagementPage> createState() => _MyIrrigationManagementPageState();
}

class _MyIrrigationManagementPageState extends State<MyIrrigationManagementPage>
  ...
  List<Irrigation> ORG_Irrigation = [
    Irrigation(
        id: "1",
        days: "1-14 Days",
        stage: "Critical Stage: Germination & establishment phase",
        methodology: "3 Irrigation after sowing, life irrigation -4th & 12th days after sowing through surface irrigation",
        operations: "Nitrogen should be applied in 5-splits as detailed below for higher productivity and "
            "use efficiency. N application at grain filling results in better grain "
            "filling. therefore, nitrogen should be applied in five splits as per below mentioned for higher N use efficiency.",),
  ];

  List<IrrigationData> ORG_IrrigationData = [
    IrrigationData(
        id: "1",
        days: "15-39 Days",
        stage: "Critical Stage: Vegetative phase",
        methodology: "25th and 36th days after sowing through surface irrigation.",
    ),
    IrrigationData(
        id: "2",
        days: "40-65 Days",
        stage: "Critical Stage: Flowering phase",
        methodology: "48th and 60th days after sowing through surface irrigation.",
    ),
    IrrigationData(
        id: "3",
        days: "66-95 Days",
        stage: "Critical Stage: Maturity phase",
        methodology: "72th and 85th days after sowing through surface irrigation.",
    ),
  ];
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            ListView.builder(
              itemCount: ORG_Irrigation.length,
              shrinkWrap: true,
                          ...
                          children: <Widget>[
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Align(
                                        alignment: Alignment.topLeft,
                                        child: Text(
                                          ORG_Irrigation[index].methodology ?? "",
                                          textAlign: TextAlign.start,
                                          style: const TextStyle(
                                              fontSize: 11,
                                              fontFamily: 'poppins-medium'),
                            ...
                            Flexible(
                              child: Padding(
                                ...
                                child: Text(ORG_Irrigation[index].operations ?? "",
            ...
            ListView.builder(
              itemCount: ORG_IrrigationData.length,
              shrinkWrap: true,
              physics: const NeverScrollableScrollPhysics(),
              itemBuilder: (context, index) {
                return
                          ...
                          children: <Widget>[
                            ...
                            Flexible(
                              child: Padding(
                                ...
                                child: Center(
                                  child: Text(
                                    ORG_IrrigationData[index].stage ?? "",
                                    textAlign: TextAlign.center,
                                    softWrap: true,
                                    style: const TextStyle(
                                      // color: Color(0xFF666666),
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Align(
                                        alignment: Alignment.topLeft,
                                        child: Text(
                                          ORG_IrrigationData[index].methodology ?? "",
                                          textAlign: TextAlign.start,
                                          style: const TextStyle(
                                              fontSize: 11,
                                              fontFamily: 'poppins-regular'),
