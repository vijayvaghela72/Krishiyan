...
class MyDeficiencyManagementPage extends StatefulWidget {
  bool aapbarVisibility;
  Future<List<CropLibraryData>?> cropData;

  MyDeficiencyManagementPage({super.key, required this.aapbarVisibility,  required this.cropData});

  @override
  State<MyDeficiencyManagementPage> createState() => _MyDeficiencyManagementPageState();
}

class _MyDeficiencyManagementPageState extends State<MyDeficiencyManagementPage>
