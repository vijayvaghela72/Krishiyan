...
class MyHarvestPage extends StatefulWidget {
  bool aapbarVisibility;
  Future<List<CropLibraryData>?> cropData;

  MyHarvestPage({super.key, required this.aapbarVisibility, required this.cropData});

  @override
  State<MyHarvestPage> createState() => _MyHarvestPageState();
}

class _MyHarvestPageState extends State<MyHarvestPage>
                                      ...
                                      children: <Widget>[
                                        Container(
                                            ...
                                            child: ElevatedButton(
                                              ...
                                              child: Text(
                                                snapshot.data![parentIndex].newHarvest!.index ??
                                                    "",
                                        ...
                                        Container(
                                            ...
                                            child: ElevatedButton(
                                              ...
                                              child: Align(
                                                ...
                                                child: Text(
                                                  snapshot.data![parentIndex].newHarvest!.conditionsDuring ?? "",
                                        ...
                                        Flexible(
                                          child: Padding(
                                            ...
                                            child: Text(
                                              snapshot.data![parentIndex].newHarvest!.prevent ??"",
                                              softWrap: true,
                                              style: const TextStyle(
                    ...
                    children: <Widget>[
                      Container(
                          ...
                          child: ElevatedButton(
                            ...
                            child: const Text(
                              '0.6 kg of maize grains per kg of cob',
                              style: TextStyle(
                                  fontSize: 14,
                                  fontFamily: 'poppins-regular'),
                            ),
                            ...
                            child: const Column(
                              children: [
                                Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    'The optimum temperature of harvesting is 20-25 C '
                                        'harvesting should be done in clear weather to prevent losses.',
                                    textAlign: TextAlign.start,
                                    style: TextStyle(
                                        fontSize: 11,
                                        fontFamily: 'poppins-regular'),
                      ...
                      const Flexible(
                        child: Padding(
                          padding: EdgeInsets.only(top: 10.0, right: 15.0, left: 15.0),
                          child: Text(
                            "1. Seed drying should be done till the moisture content of seed is reduced to 8%.",
                            softWrap: true,
                            style: TextStyle(
                              // color: Color(0xFF666666),
                                color: Colors.black,
                      ...
                      const Flexible(
                        child: Padding(
                          padding: EdgeInsets.only(top: 10.0, right: 15.0, left: 15.0),
                          child: Text(
                            "2. Seed should be stored in a cool and dry place preferably in cold storage.",
                            textAlign: TextAlign.justify,
                            softWrap: true,
                            style: TextStyle(
                              // color: Color(0xFF666666),
