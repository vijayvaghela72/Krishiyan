...
class MyEditSellCommodityPage extends StatefulWidget {
  EnquiryByFilterData enquiryData;

  MyEditSellCommodityPage({super.key, required this.enquiryData});

  @override
  State<MyEditSellCommodityPage> createState() =>
      _MyEditSellCommodityPageState();
}

class _MyEditSellCommodityPageState extends State<MyEditSellCommodityPage> {
