...
class MyEditBuyCommodityPage extends StatefulWidget {

  EnquiryByFilterData enquiryData;

  MyEditBuyCommodityPage({super.key, required this.enquiryData,});

  @override
  State<MyEditBuyCommodityPage> createState() => _MyEditBuyCommodityPageState();
}

class _MyEditBuyCommodityPageState extends State<MyEditBuyCommodityPage> {
