...
class MyFarmerGroupRegistrationTwoPage extends StatefulWidget {
  String name, type, date, email, contactNumber;

  MyFarmerGroupRegistrationTwoPage({super.key, required this.name, required this.type,
    required this.date, required this.email, required this.contactNumber});

  @override
  State<MyFarmerGroupRegistrationTwoPage> createState() => _MyFarmerGroupRegistrationTwoPageState();
}

class _MyFarmerGroupRegistrationTwoPageState extends State<MyFarmerGroupRegistrationTwoPage> {
