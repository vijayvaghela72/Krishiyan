...
class MyManufactureRegistrationPage extends StatefulWidget {
  const MyManufactureRegistrationPage({super.key});

  @override
  State<MyManufactureRegistrationPage> createState() => _MyManufactureRegistrationPageState();
}

class _MyManufactureRegistrationPageState extends State<MyManufactureRegistrationPage> {
