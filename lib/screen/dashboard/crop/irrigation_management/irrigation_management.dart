            ...
            FutureBuilder<CropLibraryData>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  ...
                  if (cropData.irrigation == null ||
                      cropData.irrigation!.isEmpty) {
                    return const Text(
                        'No irrigation data available for this crop.');
                  }

                  return ListView.builder(
                    itemCount: cropData.irrigation!.length,
                    shrinkWrap: true,
                                ...
                                Flexible(
                                  child: Padding(
                                    padding: const EdgeInsets.only(
                                        top: 10.0, right: 15.0, left: 15.0),
                                    child: Text(
                                      cropData.irrigation![index].operations ??
                                          "",
