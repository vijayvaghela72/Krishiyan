              ...
              itemBuilder: (context, parentIndex) {
                return Padding(
                  ...
                  child: ListView.builder(
                    ...
                    physics: const NeverScrollableScrollPhysics(),
                    itemCount: filteredData!.weedManagement!.length,
                    itemBuilder: (_, index) {
                      return Padding(
                              ...
                              children: <Widget>[
                                Center(
                                  child: Container(
                                    ...
                                    child: filteredData!.weedManagement![index]
                                            .image!.isNotEmpty
                                        ? DriveImage(
                                            imageUrlData: filteredData
                                                .weedManagement![index].image!)
                                        : Container(),
                                  ),
                                ),
                                Flexible(
                                ...
                                Flexible(
                                  child: Padding(
                                    ...
                                    child: Center(
                                      child: Text(
                                        textAlign: TextAlign.center,
                                        filteredData.weedManagement![index]
                                                .category ??
                                            "",
                                        softWrap: true,
                                        style: const TextStyle(
