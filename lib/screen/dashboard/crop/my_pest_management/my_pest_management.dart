    ...
    return FutureBuilder<CropLibraryData>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          filteredData.pestManagement?.removeWhere((pestmanagement) =>
              pestmanagement.name == null && pestmanagement.solutions == null);
          ...
          return Padding(
            ...
            child: GridView.builder(
              ...
              itemCount: filteredData.pestManagement!.length,
              itemBuilder: (_, index) {
                return Padding(
                            ...
                            child: Padding(
                              ...
                              child: Center(
                                child: Text(
                                  ...
                                  filteredData.pestManagement![index].name ??
                                      "",
                                  softWrap: true,
                                  style: const TextStyle(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  showSolutionAlertDialog(
                                      context,
                                      filteredData.pestManagement![index]
                                              .solutions ??
                                          "");
                                },
