...
class FarmerGroupRegistrationPageTwo extends StatefulWidget {
  ...
  @override
  State<FarmerGroupRegistrationPageTwo> createState() =>
      _FarmerGroupRegistrationPageTwoState();
}

class _FarmerGroupRegistrationPageTwoState
    extends State<FarmerGroupRegistrationPageTwo> {
                ...
                onPressed: () {
                  if (widget.name.isNotEmpty &&
                    ...
                    _registrationApiCall(
                        ...
                        widget.date,
                        widget.email,
                        nameofPromoterController.text.toString());
                  } else {
